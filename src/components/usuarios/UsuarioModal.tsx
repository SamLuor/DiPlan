...
import type { UserModo } from '~/server/repository/usuario.repository'
...
export function UsuarioModal() {
  ...
  function handleConfirm() {
    ...
    if (!trimmedNome || !trimmedEmail || !eixoId) return
    mutation.mutate({ id: modal?.mode === 'edit' ? modal.usuarioId : undefined, nome: trimmedNome, email: trimmedEmail, modo, eixoId })
  }
